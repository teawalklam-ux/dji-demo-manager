...
assert.match(dashboardChartSource, /animationRun/)
assert.match(dashboardChartSource, /isAnimationActive=\{false\}/)
...
assert.match(globalCss, /@keyframes hm-chart-pie-enter[\s\S]*?rotate\(-120deg\)/)
